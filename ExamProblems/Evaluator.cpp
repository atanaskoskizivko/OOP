...
protected:
    ...
    char *predicted;
public:
    Evaluator(const char *trueValues,const char *predicted)
    {
...
{
public:
    AccuracyEvaluator(char *trueValues, char *predicted): Evaluator(trueValues,predicted)
    {
    ...
    double evaluate() override
    {
        ...
        return (float )counter/ strlen(trueValues);
    }
    void print() override
    {
...
{
public:
    SensitivityEvaluator(char *trueValues, char *predicted): Evaluator(trueValues,predicted)
    {

    }
    double evaluate() override
    {
        int counter=0,counterPositives=0;
        for(int i=0;i< strlen(trueValues);i++)
        {
        ...
        return (float )counter/counterPositives;
    }
    void print() override
    {
